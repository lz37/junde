      ...
      <Background mode="light" class={style.background}>
        <div class={style.holder}>
          ...
          <ElRow style={{ marginTop: '60px' }}>
            <ElCol lg={12} md={24} sm={24} xs={24}>
              <div class={style.text}>
                ...
                productively way. We have it named “Offshore Development
                Center”, which is tested and proved to be an effective approach
                for collaboration with you, then create “software with true
                value” together.
                <br /> We believe in the loyalty employee on JUNDE is as
                important as the loyalty our clients on us, we create and
                maintain this company to be:
              </div>
            </ElCol>
          ...
          <div class={style.question}>
            JUNDE has been running for over 12 years, would like to know
            further?
          </div>
